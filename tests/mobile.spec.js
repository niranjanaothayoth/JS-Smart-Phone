...
describe('MobileCampus', () => {
  ...
  // Example usage
  const androidPhone = new AndroidPhone('Galaxy', '4GB', '4000mAh', 25000);
  console.log(androidPhone.displayFeatures());

  const iphone = new IPhone('iPhone X', '3GB', '3000mAh', 75000);
  console.log(iphone.displayFeatures());

  const campus = new MobileCampus(100, 50, 50);
  console.log(campus.changeMobileAvailabilityNumber(5, 'android'));
});
